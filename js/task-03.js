...
const imageInsert = images.map(({ url, alt }) => {
  return `<li><img src="${url}" alt="${alt}" height="250" width="420"></li>`;
});

const imagesElement = imageInsert.join("");
galleryEl.insertAdjacentHTML("afterbegin", imagesElement);
